...
ninja.data = [{
    ...
    handler: () => {
      ...
      handler: () => {
          ...
          description: "",
          section: "News",},{id: "news-our-paper-cns-is-accepted-by-iccv-2025",
          title: 'Our paper “CNS” is accepted by ICCV 2025.',
          description: "",
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/jasper0314-huang", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
